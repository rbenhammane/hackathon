...
define([config.appName], function (app) {
    ...
    app.register.controller('DonatorController', ['$scope', '$sce', 'commonFactory', 'mapTools', 
        ...
        var suppliersCallback = function(suppliers) {
            ...
            suppliers.forEach(function(supplier) {
                ...
                supplier.infoWindowContent = '<h3>' + supplier.name + '<br><small>Tel: ' + supplier.tel + '</small></h3><br >' + supplier.description  +
                    '<table class="foods">' +
        ...
        commonFactory.donators(function(donators) {
